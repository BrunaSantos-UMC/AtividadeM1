...
import com.example.crud.service.CepSearch;
...
public class ProductController {
    ...
    @Autowired
    public ProductController(ProductRepository repository, AddressSearch addressSearch, CepSearch cepSearch, AvailabilityService availabilityService) {
    ...
    public ResponseEntity<Boolean> checkAvailability(
        ...
        boolean available = availabilityService.checkAvailability(cep, productId);
    ...
    public ResponseEntity updateProduct(@RequestBody @Valid RequestProduct data){
        ...
        if (optionalProduct.isPresent()) {
            ...
            product.setDistribution_center(data.distribution_center());
